...
# Make sure we can import local EnhancedSASTAnalyzer
...
# -------------------------------
def parse_args():
    parser = argparse.ArgumentParser(description="Run Enhanced SAST on HTML/Code file")
    parser.add_argument("--input", required=True, help="Path to HTML file to scan")
    parser.add_argument("--model", default=None, help="Path to enhanced_sast_models.joblib")
    parser.add_argument("--output", default="sast_enhanced_report.json", help="Output JSON report path")
...
args = parse_args()   # <--- use the correct function name
